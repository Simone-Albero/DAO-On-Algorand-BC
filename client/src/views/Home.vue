			...
			<div class="col-md m-3">
				<div class="card shadow activities-card">
					...
					<div class="card-body">
						...
						<div v-for="dao in daos" :key="dao.appId" class="">
							<router-link class="link-box" :to="{name: 'daoDetails', params: {id: dao._id}}">
                                <div class="card card-link bg-light m-2">
									<div v-if="daos.isAssociation" class="card-header d-flex justify-content-center"><i class="bi bi-briefcase mr-1"></i>Association</div>
						...
						<div class="d-flex justify-content-center mt-4">
							<router-link class="btn btn-outline-primary btn-sm" to="/dao">
			...
			<div class="col-md m-3">
				<div class="card shadow activities-card">
					...
					<div class="card-body">
						...
						<div class="d-flex justify-content-center mt-4">
							<router-link class="btn btn-outline-primary btn-sm" to="/proposal">
								<i class="bi bi-folder-symlink"></i>
								View More
							</router-link>
						</div>
		...
		<div class="row m-3">
			...
			<div class="card shadow-sm mb-3 details-box">
				<div class="row no-gutters">
					<div class="col-md-4">
						<img src="../assets/images/home/bottom.png" class="img-fluid details-img">
					</div>
					<div class="col-md">
						<div class="card-body">
							<div class="col-md">
...
export default {
	...
	mounted() {
		...
		axios.get(defUrl + '/daos/all/' + store.state.walletAddr)
			.then((response) => {
				this.daos = response.data.slice(0, this.max_elem);
			})
			.catch((error) => {
				console.log(error);
			})
		...
		axios.get(defUrl + '/proposals/all/' + store.state.walletAddr)
			.then((response) => {
				this.proposals = response.data.slice(0, this.max_elem);
			})
			.catch((error) => {
				console.log(error);
			})
